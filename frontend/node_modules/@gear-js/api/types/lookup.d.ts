...
import type { BTreeMap, BTreeSet, Bytes, Compact, Enum, Option, Struct, U8aFixed, Vec, bool, u128, u16, u32, u64 } from '@polkadot/types-codec';
...
export interface PalletGearCall extends Enum {
    ...
    readonly type: 'UploadCode' | 'UploadProgram' | 'CreateProgram' | 'SendMessage' | 'SendReply' | 'ClaimValue' | 'Run' | 'SetExecuteInherent';
}
...
export interface GearCoreErrorsSimpleErrorReplyReason extends Enum {
    ...
    readonly isUnsupported: boolean;
    readonly type: 'Execution' | 'FailedToCreateProgram' | 'InactiveActor' | 'RemovedFromWaitlist' | 'ReinstrumentationFailure' | 'Unsupported';
}
