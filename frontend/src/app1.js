...
async function listenToEvents() {
  ...
  // Replace 'yourProgramId' with the actual program ID you want to listen to
  const programId = '0x71912cb483e3f7d15a0da254b4b06554f180cebf551d43831e8f0d8d2dae79bb';

  // Subscribe to events
  gearApi.gearEvents.subscribe(({ event }) => {
    if (event.isProgramEvent && event.programId.toString() === programId) {
